  ...
  return (
    <div className="min-h-screen bg-[#070b12] text-slate-100 font-sans selection:bg-cyan-500/30 scroll-smooth antialiased">
      ...
      <header className="fixed top-0 left-0 w-full z-50 bg-[#070b12]/80 border-b border-cyan-500/10 px-6 py-4 md:px-12 flex items-center justify-between backdrop-blur-md shadow-[0_4px_30px_rgba(0,0,0,0.8)]">
        ...
        >
          <div className="flex-shrink-0 w-[44px] h-[44px] sm:w-11 sm:h-11 rounded-full border border-cyan-500/40 overflow-hidden shadow-[0_0_10px_rgba(6,182,212,0.3)] transition-all group-hover:border-cyan-400 group-hover:shadow-[0_0_15px_rgba(6,182,212,0.6)] bg-[#0d1527] flex items-center justify-center">
            {!photoError ? (
              <img 
                src={fotoIbson} 
                alt="Ibson Vital" 
        ...
        <div className="max-w-4xl mx-auto space-y-6 z-10 flex flex-col items-center" data-reveal>
          ...
          <div className="pt-4 flex flex-col sm:flex-row items-center gap-4">
            <button 
              ...
              className="bg-cyan-500 hover:bg-cyan-400 text-[#070b12] font-bold px-8 py-3.5 rounded-md transition-all duration-300 hover:shadow-[0_0_25px_rgba(6,182,212,0.5)] hover:-translate-y-0.5 group flex items-center justify-center"
            >
              Ver Projetos
